...
// 		Setting hardcoded data until we can get it working. 
    	File f = filepath.toFile(); // Useless for now. Normally passed into Media constructor
    	this.setArtist("Daft Punk");
    	this.setTitle("Get Lucky");
